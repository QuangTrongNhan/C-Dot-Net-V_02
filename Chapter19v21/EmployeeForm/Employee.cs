...
namespace EmployeeForm
{
    public partial class Employee : Form
    {
        ...
        private void dgEmployees_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if(dgEmployees.Rows[e.RowIndex].Cells[e.ColumnIndex].Value != null)
            {
                dgEmployees.CurrentRow.Selected = true;
                txtFullName.Text = dgEmployees.Rows[e.RowIndex].Cells[0].FormattedValue.ToString();
                dTPDOB.Text = dgEmployees.Rows[e.RowIndex].Cells[1].FormattedValue.ToString();
                groupBox1.Text = dgEmployees.Rows[e.RowIndex].Cells[2].FormattedValue.ToString();
                if (groupBox1.Text.Equals("Male"))
                {
                ...
                cbNational.Text = dgEmployees.Rows[e.RowIndex].Cells[3].FormattedValue.ToString();
                mtxtPhone.Text = dgEmployees.Rows[e.RowIndex].Cells[4].FormattedValue.ToString();
                txtAddress.Text = dgEmployees.Rows[e.RowIndex].Cells[5].FormattedValue.ToString();
                cbQualification.Text = dgEmployees.Rows[e.RowIndex].Cells[6].FormattedValue.ToString();
                txtSalary.Text = dgEmployees.Rows[e.RowIndex].Cells[7].FormattedValue.ToString();
                indexRow = e.RowIndex;
            }
        }
        ...
        void UpdateEmployee()
        {
            ...
            dgEmployees.Rows[indexRow].SetValues(txtFullName.Text,
            dTPDOB.Value.ToShortDateString(),
            gender, cbNational.Text, mtxtPhone.Text, txtAddress.Text,
            cbQualification.Text, txtSalary.Text);
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            if (indexRow >= 0)
            {
                ...
                {
                    DataGridViewRow row = dgEmployees.Rows[indexRow];
